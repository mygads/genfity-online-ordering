...
function getEmptyStateConfig(type: EmptyStateType) {
  const configs: Record<EmptyStateType, {
    ...
    'no-data': {
      ...
      illustration: (
        <svg className="h-32 w-32 text-gray-300 dark:text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    'error': {
      ...
      illustration: (
        <svg className="h-32 w-32 text-error-300 dark:text-error-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export function NoMenuIllustration() {
  return (
    <div className="relative">
      <svg className="h-40 w-40 text-gray-200 dark:text-gray-700" viewBox="0 0 200 200" fill="currentColor">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <svg className="h-16 w-16 text-brand-200 dark:text-brand-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
        </svg>
      </div>
    </div>
...
export function NoCategoryIllustration() {
  return (
    <div className="relative">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <svg className="h-16 w-16 text-purple-200 dark:text-purple-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
